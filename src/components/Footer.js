      ...
      <div className="copyright-names">
        ...
        <div className="creators">
          ...
          <div className="icons">
            ...
            <Link to={{ pathname: 'https://github.com/Gambit142' }} target="_blank" rel="noopener noreferrer"><AiFillGithub className="git fab fa-github-square" /></Link>
            <Link to={{ pathname: 'https://www.linkedin.com/in/francis-ugorji/' }} target="_blank" rel="noopener noreferrer"><AiFillLinkedin className="linkedin fab fa-linkedin" /></Link>
          </div>
        </div>
      </div>
    </div>
